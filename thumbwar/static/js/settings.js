...
const ROWS = [
  ...
  { key: 'overlay_needs_you', label: 'overlay when an agent needs you', kind: 'toggle' },
  ...
  { key: 'sound', label: 'ui sounds', kind: 'toggle' },
  { key: 'sound_volume', label: 'sound volume', kind: 'slider',
    min: 0.1, max: 1, step: 0.1, fmt: (v) => Math.round(v * 100) + '%' },
